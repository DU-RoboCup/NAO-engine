...
public: 
    ...
    hal_access(std::shared_ptr<AL::ALBroker> broker_ptr, const std::string &broker_name_ptr);
...
private:
    ...
    DCMProxy *dcm_proxy = nullptr; //DCMProxy, communicate with the DCM directly with this
    ...
    //ALMemory
    AL::ALMemoryProxy *nao_memory_proxy = nullptr; //ALMemory proxy, communicate directly with the NAOs memory with this
