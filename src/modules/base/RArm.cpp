...
RArm::RArm() 
{
	...
	shoulder_roll_bounds = std::make_pair<double, double>(-1.3265, 0.3142);
	shoulder_pitch_bounds = std::make_pair<double, double>(-2.0857, 2.0857);
	elbow_roll_bounds = std::make_pair<double, double>(0.0349, 1.5446);
...
void RArm::set_shoulder(double roll, double pitch)
{
