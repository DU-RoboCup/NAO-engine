...
const int NumOfStiffnessActuatorIds = BetterActuatorIds::NumOfPositionActuatorIds;
const int NumOfLedActuatorIds = BetterActuatorIds::rFootLedBlueActuator + 1 - BetterActuatorIds::faceLedRedLeft0DegActuator;
